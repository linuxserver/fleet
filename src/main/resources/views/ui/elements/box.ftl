...
-->
<#macro box id="" extraClasses="" extraAttributes="">

    <div <#if id?has_content>id="${id}"</#if> class="box<#if extraClasses?has_content> ${extraClasses}</#if>"<#if extraAttributes?has_content> ${extraAttributes}</#if>>
        <article class="media">
